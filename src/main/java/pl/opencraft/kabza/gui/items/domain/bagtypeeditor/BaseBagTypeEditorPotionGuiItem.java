...
import pl.opencraft.kabza.gui.items.domain.BasePotionGuiItem;
...
public abstract class BaseBagTypeEditorPotionGuiItem extends BasePotionGuiItem<BagType> {

    public BaseBagTypeEditorPotionGuiItem(GuiItemType type) {
        super(type);
    }

    public BaseBagTypeEditorPotionGuiItem(GuiItemType type, GuiParams<BagType> params) {
        super(type, params);
    }

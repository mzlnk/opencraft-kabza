...
import pl.opencraft.kabza.gui.items.domain.BaseGuiItem;
...
public abstract class BaseBagTypeEditorGuiItem extends BaseGuiItem<BagType> {

    public BaseBagTypeEditorGuiItem(GuiItemType guiItemType) {
        super(guiItemType);
    }

    public BaseBagTypeEditorGuiItem(GuiItemType guiItemType, GuiParams<BagType> params) {
        super(guiItemType, params);
    }
